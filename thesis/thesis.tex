...
\emph{marginal likelihood} (sometimes called \emph{evidence}) \(p(y_t|y_{1:t-1})\). % TODO: right? (even time indices?) citation for this!
...
Generalised versions / EKF, K with control...

...
\begin{tabular}{l p{0.8\textwidth}}
	...
	\(\widehat{N}\) & when \(N \in \mathbb{N}\): set of numbers \(\{1, 2 \dots N-1, N\}\) \\
	...
	\(p(a_t)\) & probability density function{\footnotemark} of quantity \(a\) at time \(t\) (unless
		noted otherwise) \\
	...
	\(\delta(a)\) & Dirac delta function; used exclusively in context of {\pdfs} to denote discrete
		distribution within framework of continuous distributions \\

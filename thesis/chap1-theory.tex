...
Described particle filter is initialised by sampling \(N\) random particles from the initial {\pdf}
...
\cite{AruMasGor:02}), a second one is to add additional \emph{resample} step to above
